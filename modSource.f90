...
!======= [Spatial]_[Velocity] source distribution ==================
	...
	!Keep A(4) number of ion, Uniform on x\in[(0.5-A(1))*L, (0.5+A(1))*L], Rayleigh on v with \sigma = A(2),A(3) (electron,ion)
	...
	!Keep A(4) number of ion, Uniform on x\in[(0.5-A(1))*L, (0.5+A(1))*L], Maxwellian on v with \sigma = A(2),A(3) (electron,ion)
