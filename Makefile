...
EXE = exec
F90SRC = main.f90 constants.f90 MatrixVector.f90 modSpecies.f90 modMesh.f90 modAssign.f90 modRecord.f90 modPM1D.f90 random.f90 init.f90 modBC.f90 modTarget.f90 modSource.f90 timeStep.f90
F90OBJ = main.o constants.o MatrixVector.o modSpecies.o modMesh.o modAssign.o modRecord.o modPM1D.o random.o init.o modBC.o modTarget.o modSource.o timeStep.o
...
timeStep.o : modTarget.o modSource.o modBC.o modRecord.o
